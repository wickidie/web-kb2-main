...
<body class="">
    ...
    <main class="container-fluid p-3">
        <article class="container">
            <section class="row grid gap-0 column-gap-3 justify-content-center">
                <div>
                    <p class="fs-2 fw-bold">Profile <small class="fw-light"></small></p>
                </div>
                <div class="col-auto card shadow p-0">
                    <div class="justify-content-center align-items-center">
                        <div class="card-header">
                            <p class="my-2">Profile picture</p>
                        </div>
                        <div class="card-body text-center">
                            <img class="rounded-circle img-fluid mb-3" src="https://github.com/mdo.png" width="250"
                                height="250" alt="Image Description" />
                            <p class="mb-2">fullname</p>
                            <p class="mb-2">username</p>
                            <p class="mb-2">email@gmail</p>
                ...
                <div class="col card shadow p-0">
                    <div class="justify-content-center align-items-center">
                        ...
                        <div class="card-body">
                            <form class="needs-validation w-100" action="users-add.php" method="post" novalidate>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-5 px-1">
                                        <input type="text" class="form-control" id="lastname" name="last_name"
                                            placeholder="Lastname" aria-label="lastname" aria-describedby="lastnameph"
                                            required />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="username_input" name="username"
                                            placeholder="Username" aria-label="username" aria-describedby="usernameph"
                                            required />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="email" name="email"
                                            placeholder="Email" aria-label="Email" aria-describedby="emailph"
                                            required />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="address" name="address"
                                            placeholder="Address" aria-label="address" aria-describedby="addressph"
                                            required />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="phonenum" name="phone_number"
                                            placeholder="For example: 081123546709" aria-label="phone_number"
